...
const ClusterAnalysis = () => {
  ...
  const CustomTooltip = ({ active, payload }) => {
    if (active && payload && payload.length) {
      ...
      return (
        <div className="glass-card p-3 border border-slate-200 dark:border-slate-700 text-xs shadow-xl dark:shadow-2xl">
          <p className="font-bold text-slate-800 dark:text-slate-200 mb-1">Source: {d.ip}</p>
